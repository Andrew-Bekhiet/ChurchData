...
- **[🔐 الحماية والامان](#-الحماية-والامان)**
    ...
    - **[🛡 الصلاحيات](#-الصلاحيات)**
- **[⚒️ كيفية استخدام البرنامج (للكنيسة)](#-كيفية-استخدام-البرنامج-(للكنيسة))**
- **[📲 كيفية استخدام البرنامج من طرف الخدام (المستخدمين)](#-كيفية-استخدام-البرنامج-من-طرف-الخدام-(المستخدمين))**
- **[💁🏻‍♂️📞الدعم الفني والتواصل مع المطور](#-الدعم-الفني-والتواصل-مع-المطور)**
...
## 📲 كيفية استخدام البرنامج من طرف الخدام (المستخدمين):
1. تحميل البرنامج على الهاتف
2. فتح البرنامج وتسجيل الدخول بحساب جوجل
3. ملئ استمارة البيانات للمستخدم وانتظار موافقة الدخول للبرنامج من أحد المسؤولين
4. عند موافقة المسؤول يستطيع المستخدم استخدام البرنامج
>ملحوظة: إذا لم يوافق أحد المسؤولين لن يستطيع المستخدم رؤية اي بيانات داخل البرنامج

## 💁🏻‍♂️📞 الدعم الفني والتواصل مع المطور:
يمكنكم التواصل مع مطور البرنامج أندرو أقلديوس بخيت من خلال البريد الاكتروني:
andrew.a.bekhiet@gmail.com
</div>